...
export default function Popover({
    ...
    return (
        <div
            className={`absolute bg-slate-200 dark:bg-gray-800 p-3 rounded-lg shadow-lg bottom-full left-1/2 -translate-x-1/2 mb-2 transition-opacity duration-200 dark:bg-black/40 backdrop-blur-md border border-white/10 rounded-full p-3 ${

...
import type {
  usePopoverBehaviourParams,
  usePopoverBehaviourResult,
} from "../contracts/Popover";
import PopoverRegistry from "./popoverRegistry";

export function usePopoverBehaviour(
  { triggerElementRef, popoverElementRef }: usePopoverBehaviourParams,
): usePopoverBehaviourResult {
  ...
  }, [triggerElementRef, popoverElementRef]);

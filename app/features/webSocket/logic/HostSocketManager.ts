...
import type { SocketManager, socketParams } from "../contracts/socket";
...
class HostSocketManager extends BaseSocketManager implements SocketManager {
  ...
  initializeMediaStream() {
    return captureStream(this.videoElement)
      .then((stream) => {
  ...
  override handleUserJoined(data: peerSetupMeta): void {
  ...
  override handleUserLeft(data: peerSetupMeta): void {

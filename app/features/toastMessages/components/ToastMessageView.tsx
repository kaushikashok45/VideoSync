...
export default function ToastMessageView({
  ...
  return (
    ...
    >
      <p className="text-sm h-15 w-10 max-h-15 max-w-10 p-3 border rounded-full border-gray-600 bg-white text-black flex justify-center items-center text-nowrap">
